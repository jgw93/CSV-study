...
public class Main {
    public static void WriteDate(String fileName) throws IOException {
    ...
    public static void main(String[] args) {
        ...
        // CSVWriter : OpenCsv 라이브러리에서 제공하는 클래스로 csv 파일을 생성 및 내용 쓰기 시
        //             사용하는 클래스
        // writeNext(문자열) : 지정한 문자열의 배열을 csv 파일에 쓰기, 한줄 쓰기
        // writeAll(List<String[]>) : 지정한 List<String[]> 타입의 데이터를 csv 파일에 한번에
        //                             모두 쓰기
        // close() : csv 파일을 닫기
        // CSVReader : OpenCsv 라이브러리에서 제공하는 클래스로 csv 파일의 내용을 읽을 경우
        //             사용하는 클래스
